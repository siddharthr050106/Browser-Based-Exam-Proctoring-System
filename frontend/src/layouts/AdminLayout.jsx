...
import { BarChart3, BookOpen, Users, FileText, LogOut, Cog } from 'lucide-react'
      ...
      <aside className="w-64 glass border-r border-surface-800 flex flex-col fixed h-full z-10">
        ...
        <div className="p-4 border-t border-surface-800">
          <div className="flex items-center gap-3 px-4 py-2">
            <div className="w-8 h-8 rounded-full bg-amber-600/30 flex items-center justify-center text-sm font-bold text-amber-300">
              {user?.full_name?.[0] || 'A'}
            </div>
